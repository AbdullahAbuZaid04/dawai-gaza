...
function Footer() {
  ...
  return (
    <footer dir="rtl" className="bg-ui-footer text-content-light py-12 md:pt-20">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-10 text-right">
          ...
          <div>
            ...
            <p className="text-content-light leading-relaxed text-[0.95rem] mb-8">
            ...
            <div className="flex flex-col gap-4 text-[0.95rem]">
              {quickLinks.map((link, idx) => (
                <Link
                  key={idx}
                  to={link.path}
                  className="text-content-light hover:text-primary transition-colors w-fit"
                >
                  {link.label}
                </Link>
              ))}
            ...
            <div className="flex flex-col gap-5 text-[0.95rem]">
              {[
                ...
                <div key={idx} className="flex items-center gap-4 group">
                  ...
                  <span className="text-content-light font-medium">{item.text}</span>
                </div>
              ))}
            </div>
          </div>

...
const EditMedicineModal = ({ isOpen, onClose, onSubmit, formData, setFormData, error }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-ui-card w-full max-w-lg rounded-3xl p-6 sm:p-8 border border-ui-border shadow-2xl relative">
        <h3 className="text-xl sm:text-2xl font-black text-content-main mb-6">
          تعديل بيانات الدواء
        </h3>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                disabled
                className="w-full px-4 py-3 bg-ui-bg/10 border border-ui-border rounded-xl outline-none font-bold text-content-light"
